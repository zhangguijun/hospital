...
<body>
                ...
                <div class="hearder_top">
                        <div class="container">
                                ...
                                <div class="sn-quick-menu fr">
                                        <a class="sn-sys logo-behind" href="http://localhost/Hospital/index.php/Sys/Sys/lst"></a>
                                        <a class="sn-hos logo-behind" href="http://localhost/Hospital/index.php/Hos/Hos/lst"></a>
                                        <a class="sn-doc logo-behind" href="http://localhost/Hospital/index.php/Doc/Doc/lst"></a>
                                        <a class="sn-pat logo-behind" href="http://localhost/Hospital/index.php/Pat/Pat/lst"></a>
            ...
            <div id="login" class="col-md-6">
                    <h1>登录管理</h1>	
                        <form method="post">
                            ...
                            <p><input type="password" name="passwd" id="pwd"  required></p>
                            <p><input type="botton" id="submit"  class="btn btn-success" value="登录"></p>
        ...
        <div class="footer container">
            ...
            <script>var submitUrl ="http://hospital.com/index.php/Home/Login/doLogin";</script>
