...
<div class="container">
<div class="clearfix">
  <h3 class="page-header fl" style="width:200px" ><a href="http://hospital.com/index.php/Home/home/index">医生界面</a></h3>
    ...
    <div class="col-md-2" style="padding-left: 0px;">
      <div class="well menuSideBar" style="padding: 8px 0px;">
        <ul class="nav nav-list" id="menuSideBar">
          ...
          <li mid="tab1" funurl="zuozhenshijianguanli.html"><a tabindex="-1" href="javascript:void(0);">坐诊时间管理</a></li>
          <li mid="tab2" funurl="guahaoxinxiguanli.html"><a tabindex="-1" href="javascript:void(0);">挂号信息管理</a></li>
          <li mid="tab3" funurl="personinfo.html"><a tabindex="-1" href="javascript:void(0);">个人信息管理</a></li>
        </ul>
      </div>
    </div>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="bTabs_navTabsMainPage">
          <div class="page-header">
            <h2 style="font-size: 31.5px;text-align: center;font-weight: normal;">你好，医生</h2>
          </div>
        </div>
      </div>
    </div>
