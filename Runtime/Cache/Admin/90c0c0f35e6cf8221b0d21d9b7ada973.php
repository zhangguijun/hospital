...
<div class="container">
    <div class="clearfix">
        <h3 class="page-header fl" style="width:200px" ><a href="http://hospital.com/index.php/Home/home/index">医院管理员</a></h3>
    ...
    <div class="col-md-2" style="padding-left: 0px;">
      <div class="well menuSideBar" style="padding: 8px 0px;">
        <ul class="nav nav-list" id="menuSideBar">
          ...
          <li mid="tab1" funurl="hospitalinfomanage.html"><a tabindex="-1" href="javascript:void(0);">医院信息管理</a></li>
          <li mid="tab2" funurl="keshiguanli.html"><a tabindex="-1" href="javascript:void(0);">科室管理</a></li>
          <li mid="tab3" funurl="zhuanjiaguanli.html"><a tabindex="-1" href="javascript:void(0);">专家管理</a></li>
          <li mid="tab4" funurl="yishengguahaoguanli.html"><a tabindex="-1" href="javascript:void(0);">挂号管理</a></li>
          <li mid="tab5" funurl="blacklist.html"><a tabindex="-1" href="javascript:void(0);">黑名单管理</a></li>
          <li mid="tab6" funurl="datalist.html"><a tabindex="-1" href="javascript:void(0);">数据报表管理</a></li>
        </ul>
      </div>
    </div>
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="bTabs_navTabsMainPage">
          <div class="page-header">
            <h2 style="font-size: 31.5px;text-align: center;font-weight: normal;">你好医院管理员</h2>
          </div>
        </div>
      </div>
    </div>
